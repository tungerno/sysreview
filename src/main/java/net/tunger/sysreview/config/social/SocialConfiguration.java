package net.tunger.sysreview.config.social;

import net.tunger.sysreview.repository.SocialUserConnectionRepository;
import net.tunger.sysreview.repository.CustomSocialUsersConnectionRepository;
import net.tunger.sysreview.security.social.CustomSignInAdapter;
