package net.tunger.sysreview.repository;

import net.tunger.sysreview.SysreviewApp;
import net.tunger.sysreview.config.Constants;
import net.tunger.sysreview.config.audit.AuditEventConverter;
import net.tunger.sysreview.domain.PersistentAuditEvent;
...
import static net.tunger.sysreview.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
