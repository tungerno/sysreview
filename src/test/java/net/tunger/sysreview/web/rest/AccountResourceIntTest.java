package net.tunger.sysreview.web.rest;

import net.tunger.sysreview.config.Constants;
import net.tunger.sysreview.SysreviewApp;
import net.tunger.sysreview.domain.Authority;
import net.tunger.sysreview.domain.PersistentToken;
import net.tunger.sysreview.domain.User;
import net.tunger.sysreview.repository.AuthorityRepository;
import net.tunger.sysreview.repository.PersistentTokenRepository;
import net.tunger.sysreview.repository.UserRepository;
import net.tunger.sysreview.security.AuthoritiesConstants;
import net.tunger.sysreview.service.MailService;
import net.tunger.sysreview.service.dto.UserDTO;
import net.tunger.sysreview.web.rest.errors.ExceptionTranslator;
import net.tunger.sysreview.web.rest.vm.KeyAndPasswordVM;
import net.tunger.sysreview.web.rest.vm.ManagedUserVM;
import net.tunger.sysreview.service.UserService;
...
@SpringBootTest(classes = SysreviewApp.class)
